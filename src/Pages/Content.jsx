    ...
    return (
        <div class="mid-container">
            <div class="profile">
                ...
                <p>I am a civil engineer and web developer.</p>
            ...
            <div className="skills">
                ...
                <div className="logo-flex">
                    ...
                    <img class="logo" src="CSS/Images/postman.png" alt="githublogo" />
                    <img class="logo" src="CSS/Images/react.png" alt="githublogo" />
                </div>
            </div>
            <hr></hr>
