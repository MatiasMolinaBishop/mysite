...
function MainProjects() {
    return (
        <div>
            ...
            <Project link={"https://matiasmolinabishop.github.io/My-Notes-/"} color={'#42464e'} src="CSS/Images/notesapp.png" name={"My Notes 👨‍💻"} content1={""} content2={"This frontend web application built with React allows you to write down notes and it displays them as single components with a title and content description. Users can delete notes accordingly. There are other features such as the heading which renders a message depending on the current time."} />
            <Project link={"https://matiasmolinabishop.github.io/RobotsReact/"} color={'#2155CD'} src="CSS/Images/robots.png" name={"Robot Army 🤖"} content1={""} content2={"This is a web application built with React. It communicates with an API to fetch information and render card like components. The application also has other features like a searchbar that filters the robots."} />
