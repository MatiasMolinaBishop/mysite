...
function MainProjects() {
    return (
        <div>
            ...
            <Project link={"https://matiasmolinabishop.github.io/kanban-board/"} color={'#2155CD'} src="CSS/Images/kanban.png" name={"Kanban Board"} content1={""} content2={"Frontend web application which uses local storage to save users data. Users can create, drag, edit and delete items. The code was written in plain vanilla javascript with DOM manipulation."} />
